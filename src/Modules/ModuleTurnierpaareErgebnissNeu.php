...
class ModuleTurnierpaareErgebnissNeu extends \Module
{
  ...
  private function selectKlasseValues($turnierpaar, $value, $elemenID){
      ...
      switch ($turnierpaar['classLAT']){
       ...
       case "Sen III D": $form = $form.'<option value="Sen III C Lat">Sen III C Lat</option>'; break;
       case "Sen III C": $form = $form.'<option value="Sen III B Lat">Sen III B Lat</option>'; break;
       case "Sen III B": $form = $form.'<option value="Sen III A Lat">Sen III A Lat</option>'; break;
       case "Sen III A": $form = $form.'<option value="Sen III S Lat">Sen III S Lat</option>'; break;
       case "Sen IV D": $form = $form.'<option value="Sen IV C Lat">Sen IV C Lat</option>'; break;
       case "Sen IV C": $form = $form.'<option value="Sen IV B Lat">Sen IV B Lat</option>'; break;
       case "Sen IV B": $form = $form.'<option value="Sen IV A Lat">Sen IV A Lat</option>'; break;
       case "Sen IV A": $form = $form.'<option value="Sen IV S Lat">Sen IV S Lat</option>'; break;
       case "Sen V D": $form = $form.'<option value="Sen V C Lat">Sen V C Lat</option>'; break;
       case "Sen V C": $form = $form.'<option value="Sen V B Lat">Sen V B Lat</option>'; break;
       case "Sen V B": $form = $form.'<option value="Sen V A Lat">Sen V A Lat</option>'; break;
       case "Sen V A": $form = $form.'<option value="Sen V S Lat">Sen V S Lat</option>'; break;
     ...
     switch ($turnierpaar['classSTD']){
       ...
       case "Sen V D": $form = $form.'<option value="Sen V C Std">Sen V C Std</option>'; break;
       case "Sen V C": $form = $form.'<option value="Sen V B Std">Sen V B Std</option>'; break;
       case "Sen V B": $form = $form.'<option value="Sen V A Std">Sen V A Std</option>'; break;
       case "Sen V A": $form = $form.'<option value="Sen V S Std">Sen V S Std</option>'; break;
    ...
    $paarName = "";
     ...
     $this->Template->paare = $this->selectValues(1, 0, 'paare');
